/**
 * Значки каналов связи. Один файл на весь проект: раньше WhatsApp жил внутри
 * кнопки записи, а Instagram и Facebook — внутри экрана результатов, и при
 * первой же правке они разъехались бы.
 *
 * Все три нарисованы в одной сетке 24×24 одной толщиной штриха, чтобы в ряду
 * читались как набор, а не как три случайные картинки.
 */
const BOX = 'shrink-0';
